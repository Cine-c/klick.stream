...
export const RED_CARPET_EVENTS = [
  ...
  {
    id: 'avengers-doomsday-premiere-2026',
    title: 'Avengers: Doomsday — World Premiere',
    type: 'Premiere',
    date: '2026-12-12',
    location: 'Dolby Theatre, Hollywood',
    accent: '#b8352c',
    blurb:
      'The Multiverse Saga reaches its breaking point. Marvel Studios unveils its biggest team-up yet on the red carpet, days before it storms theaters for the holidays.',
    films: ['Avengers: Doomsday'],
    watch: 'In theaters Dec 16',
    tmdbId: 1003596,
    overview:
...
export const RED_CARPET_IMAGES = {
  ...
  'dune-three-premiere-2026': IMG('/5jnVGQXsc0oXLlWD9q6KuwacWQ2.jpg'),
  'avengers-doomsday-premiere-2026': IMG('/4OZznMYFmQPP4orKgbLaWRyYmBb.jpg'),
